...
def get_token(client_id: int, json_file, engine, logger):
    ...
    query = f"""
                ...
                # WHERE al.mp_id = 16 AND asd.attribute_id = 24 AND al.status_1 = 'Active' and asd.attribute_value = '{client_id}' 
                # GROUP BY asd.attribute_id, asd.attribute_value, asd2.attribute_id, asd2.attribute_value, al.id 
                """

    access_token = json_file.get("access_token", None)
